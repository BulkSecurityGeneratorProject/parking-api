...
import com.companyname.parking.api.domain.user.UserNotActivatedException;
...
public class UserDetailsApplicationService implements UserDetailsService {
    ...
    private final Logger log = LoggerFactory.getLogger(UserDetailsApplicationService.class);

    private final UserRepository userRepository;

    public UserDetailsApplicationService(UserRepository userRepository) {
